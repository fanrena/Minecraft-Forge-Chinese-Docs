...
原文地址：https://docs.minecraftforge.net/en/1.20.1/

## 内容

- 完整翻译 72 篇文档（纯 AI 翻译），涵盖入门指南、核心概念、方块、物品、网络、渲染、数据生成等全部主题
- 术语遵循中文 Minecraft 模组社区通用译法
- 代码示例、API 引用、类名保持原文不变
- 附带 `AI_README.md`，为 AI 辅助开发提供紧凑术语表和结构索引
